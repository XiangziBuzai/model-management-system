...
.user-profile::before {
  ...
  bottom: 0;
  background:
    radial-gradient(ellipse at 20% 10%, rgba(64, 158, 255, 0.15) 0%, transparent 50%),
    radial-gradient(ellipse at 80% 90%, rgba(255, 119, 198, 0.1) 0%, transparent 50%);
  pointer-events: none;
  z-index: 0;
}
...
.profile-header::before {
  ...
  width: 200%;
  height: 200%;
  background: radial-gradient(ellipse at center, rgba(64, 158, 255, 0.15) 0%, transparent 60%);
